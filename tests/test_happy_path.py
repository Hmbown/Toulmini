    ...
    data_json = json.dumps(
        {
            ...
            "citations": [
                {"source": "AI Safety Institute", "reference": "2024 Report"}
            ],
            "evidence_type": "empirical",
        }
    )
    claim_json = json.dumps(
        {"statement": "AI requires regulatory oversight.", "scope": "general"}
    )
